...
function WebFXLoadTreeItem(sText, sXmlSrc, sAction, sCId, eParent, sIcon, sOpenIcon) {
	// call super
...
function _xmlTreeToJsTree(oNode) {
	...
	var cId = oNode.getAttribute("cId"); //PW modify
