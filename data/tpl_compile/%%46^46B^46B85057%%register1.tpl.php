<?php /* Smarty version 2.6.22, created on 2013-07-16 09:49:23
         compiled from brules/register1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'fp', 'brules/register1.tpl', 111, false),)), $this); ?>
...
.regsteps{margin:10px auto 10px;height:40px;background:url(/ui/img/regsteps.png) no-repeat;width: 980px;}
...
<div class="banner">
    <ul class="regsteps regsteps-1">
        ...
        <li class="step-2"><em>2</em> 绑定车辆</li>
        <li class="step-3"><em>3</em> 绑定手机号</li>
        <li class="step-4"><em>4</em> 开通短信定制服务</li>
    </ul>
</div>
