<?php /* Smarty version 2.6.22, created on 2013-07-16 10:08:09
         compiled from admin/column/content1_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'admin/column/content1_list.tpl', 145, false),array('modifier', 'truncate_utf8', 'admin/column/content1_list.tpl', 146, false),array('modifier', 'date_format', 'admin/column/content1_list.tpl', 161, false),)), $this); ?>
...
<script src="<?php echo @URL; ?>
/admin/javascript/showDiv.js" type="text/javascript" language="javascript"></script>
</head>
<?php echo '
<style>
div#qTip {
...
<tr class="tr2">
    ...
    <td><span id="orderhits" class="st">权重</span></td>
...
">
    ...
    <td title="<?php echo $this->_tpl_vars['contentindexList'][$this->_sections['s']['index']]['title']; ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=@$this->_tpl_vars['contentindexList'][$this->_sections['s']['index']]['title'])) ? $this->_run_mod_handler('default', true, $_tmp, "&nbsp;") : smarty_modifier_default($_tmp, "&nbsp;")))) ? $this->_run_mod_handler('truncate_utf8', true, $_tmp, '20') : smarty_modifier_truncate_utf8($_tmp, '20')); ?>
...
"><img src="/admin/images/img.gif" /></a><?php endif; ?>	</td>
  ...
  <td>
  <div id='d_<?php echo $this->_sections['s']['index']; ?>
' oncontextmenu="digest('<?php echo $this->_tpl_vars['contentindexList'][$this->_sections['s']['index']]['id']; ?>
','<?php echo $this->_sections['s']['index']; ?>
','0');return false;">
  <div onmouseout="reSet('<?php echo $this->_sections['s']['index']; ?>
','<?php echo $this->_tpl_vars['contentindexList'][$this->_sections['s']['index']]['digest']; ?>
');" id="digest_<?php echo $this->_sections['s']['index']; ?>
">
  <img id='img<?php echo $this->_sections['s']['index']; ?>
_1' class='st' src='/admin/images/star_no.gif' onmouseover="showStar('<?php echo $this->_sections['s']['index']; ?>
','1');" onclick="digest('<?php echo $this->_tpl_vars['contentindexList'][$this->_sections['s']['index']]['id']; ?>
','<?php echo $this->_sections['s']['index']; ?>
','1');" />
  <img id='img<?php echo $this->_sections['s']['index']; ?>
_2' class='st' src='/admin/images/star_no.gif' onmouseover="showStar('<?php echo $this->_sections['s']['index']; ?>
','2');" onclick="digest('<?php echo $this->_tpl_vars['contentindexList'][$this->_sections['s']['index']]['id']; ?>
','<?php echo $this->_sections['s']['index']; ?>
','2');" />
  <img id='img<?php echo $this->_sections['s']['index']; ?>
_3' class='st' src='/admin/images/star_no.gif' onmouseover="showStar('<?php echo $this->_sections['s']['index']; ?>
','3');" onclick="digest('<?php echo $this->_tpl_vars['contentindexList'][$this->_sections['s']['index']]['id']; ?>
','<?php echo $this->_sections['s']['index']; ?>
','3');" />  </div>
  </div>
  <script>reSet('<?php echo $this->_sections['s']['index']; ?>
','<?php echo $this->_tpl_vars['contentindexList'][$this->_sections['s']['index']]['digest']; ?>
');</script>  </td>
...
" size="3" maxlength="3"></td>
  <td><?php echo ((is_array($_tmp=@$this->_tpl_vars['contentindexList'][$this->_sections['s']['index']]['hits'])) ? $this->_run_mod_handler('default', true, $_tmp, '0') : smarty_modifier_default($_tmp, '0')); ?>
</td>
  <td>
  <?php if ($this->_tpl_vars['contentindexList'][$this->_sections['s']['index']]['ifpub'] == 1): ?>已审核<?php else: ?><font color="#FF0000">未审核</font><?php endif; ?></td>
...
&cid=<?php echo $this->_tpl_vars['cid']; ?>
&mid=<?php echo $this->_tpl_vars['mid']; ?>
"><img src="/admin/images/pub.gif" align="absmiddle" alt="发布内容" /></a>
</td>
  </tr>
<?php endfor; endif; ?>
</table>
