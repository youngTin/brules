<?php /* Smarty version 2.6.22, created on 2013-07-16 09:31:48
         compiled from brules/invite.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'brules/invite.tpl', 25, false),array('modifier', 'date_format', 'brules/invite.tpl', 40, false),)), $this); ?>
...
?><li><?php echo $this->_tpl_vars['item']['username']; ?>
    ...
    <div class="invite_pri">
        <h3>您的专属链接</h3>
        <div class="ip_info">
            <p><input type="text" class="link" name="link" id="link" value="http://www.jiazhao999.com/i/<?php echo $this->_tpl_vars['info']['uid']; ?>
