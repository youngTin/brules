<?php /* Smarty version 2.6.22, created on 2013-12-02 11:59:40
         compiled from service/serv_left.tpl */ ?>
...
function howMuch()
{
    var listfee = 0 ,baseFee = '; ?>
<?php echo $this->_tpl_vars['info']['basicfee']; ?>
<?php echo ' , yFee = 0 , yDFfee = $("#year").attr(\'dataFrom\') ,yDfee = $("#year").attr(\'data\') ;
