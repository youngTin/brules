<?php /* Smarty version 2.6.22, created on 2013-05-14 19:51:41
         compiled from brules/getapi_form.tpl */ ?>
        ...
        <div class="myinfo_content">
            <form action="?action=save"  method="post" id="form1" >
                ...
                <table class="border-dashed">
                    <tr>
                        <td>违章时间：</td>
                        <td ><input type="text" name="brtime[]" class="binput" value="<?php echo $this->_tpl_vars['info']['engno']; ?>
"  /></td>
                        <td>违章地点：</td>
                        <td ><input type="text" name="braddress[]" class="binput" value="<?php echo $this->_tpl_vars['info']['engno']; ?>
"  /></td>
                        <td>违章原因：</td>
                        <td ><input type="text" name="brreason[]" class="binput" value="<?php echo $this->_tpl_vars['info']['engno']; ?>
"  /></td>
                    </tr><tr>
                        <td>扣分：</td>
                        <td ><input type="text" name="marking[]" class="binput" value="<?php echo $this->_tpl_vars['info']['engno']; ?>
"  /></td>
                        <td>罚金：</td>
                        <td ><input type="text" name="fine[]" class="binput" value="<?php echo $this->_tpl_vars['info']['engno']; ?>
"  /></td>
                    </tr>
