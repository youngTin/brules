<?php /* Smarty version 2.6.22, created on 2013-12-24 14:56:20
         compiled from admin/service/list_index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'admin/service/list_index.tpl', 21, false),array('modifier', 'default', 'admin/service/list_index.tpl', 92, false),)), $this); ?>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr class="tr4">
      <td width="90%" style="text-align:left"> 
        ...
        车主姓名：<input type="text" name="name" class="binput"  value="<?php echo $_GET['chassisno']; ?>
" maxlength="6"  />
        手机：<input type="text" name="phone" class="binput" id="phone" value="<?php echo $_GET['telephone']; ?>
" />
