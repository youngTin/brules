<?php /* Smarty version 2.6.22, created on 2013-12-24 11:03:52
         compiled from brules/psearch_index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'brules/psearch_index.tpl', 57, false),array('modifier', 'default', 'brules/psearch_index.tpl', 57, false),)), $this); ?>
            ...
            <form action="psearch.shtml?action=searchSave" id="searchPen" method="post">
                ...
                <div class="src-cols">
                    <div class="src-rows">
                        ...
                        <div class="src-put"><input class="src-lpp" type="text" name="lpp" id="s-lpp" value="川" readonly="readonly" /><input class="src-lpno"  type="text" name="lpno"  id="s-lpno" value="<?php echo $this->_tpl_vars['brinfo']['lpno']; ?>
" maxlength="6" /></div>
                        <div class="clear"></div>
                    </div>
                    <div class="src-rows">
                        <div class="src-title">车辆识别码：</div>
                        <div class="src-put"><input class="src-input"  type="text" name="cno" id="s-cno" value="<?php echo $this->_tpl_vars['brinfo']['chassisno']; ?>
" maxlength="6" /></div>
                        <div class="clear"></div>
                    </div>
                    <div class="clear"></div>
                    ...
                    <div class="src-rows">
                        ...
                        <div class="src-put">
                             <select name="vtype" id="s-vtype" class="src-input src-select">
                                <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['br_car_type'],'selected' => ((is_array($_tmp=@$this->_tpl_vars['brinfo']['vtype'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0))), $this);?>
                    ...
                    <div class="src-rows">
                        ...
                        <div class="src-put"><input class="src-input"  type="text" name="engno" id="s-engno" value="<?php echo $this->_tpl_vars['brinfo']['engno']; ?>
" maxlength="6" /></div>
                        <div class="clear"></div>
                    </div>
                    <div class="clear"></div>
        ...
        <div class="mytask_content">
            <div class="br-list">
                <form action="member_deal.php" method="post">
                    ...
                    <div class="pageer">
                        <ul><li>当前显示<span class="red"><?php echo $this->_tpl_vars['num']; ?>
