<?php /* Smarty version 2.6.22, created on 2013-03-10 17:56:00
         compiled from admin/dr/info_buy.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/dr/info_buy.tpl', 97, false),)), $this); ?>
...
<body  style="margin-top:5px;">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr class="line">
      <td>驾照所在地:</td>
      <td><?php if ($this->_tpl_vars['dist1'] == null): ?>不限<?php else: ?><?php echo $this->_tpl_vars['dist1']; ?>
<?php endif; ?></td>
    </tr>
    <tr class="line">
      <td>处理所在地:</td>
