...
<frameset rows="80,5,*" cols="*" frameborder="no" border="0" framespacing="0">
  ...
  <frameset cols="180,10,*" name="workframeset" id="workframeset" rows="*" frameborder="no" border="0" framespacing="0">
    <frame src="{$smarty.const.URL}/admin/lefttree.php" name="leftFrame" scrolling="no" noresize="noresize" id="leftFrame" title="leftFrame" />
    ...
    <frame src="{$smarty.const.URL}/admin/main.php" name="mainFrame" scrolling="yes"  noresize="noresize" id="mainFrame" title="mainFrame" style="background:#fff" />
  </frameset>
</frameset>
<noframes>
<body>
