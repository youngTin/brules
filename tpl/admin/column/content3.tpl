...
<option value="silver" style="background-color:silver;color:silver" {if $result.titlecolor=='silver'}selected="selected"{/if}>silver</option>
  ...
  <tr class="line">
	...
	<input type="hidden" id="highlights___Config" value="" style="display:none" /><iframe id="highlights___Frame" name="highlights___Frame" src="../../includes/fckeditor/editor/fckeditor.html?InstanceName=highlights&amp;Toolbar=Basic" width="650" height="150" frameborder="0" scrolling="no"></iframe></div>	</td>
  </tr>
  <tr class="line">
    <td>详细</td>
    <td>
...
<iframe id="content___Frame" src="../../includes/fckeditor/editor/fckeditor.html?InstanceName=content&Toolbar=Default" width="650" height="420" frameborder="0" scrolling="no"></iframe></div>
	{literal}
	<script>
	//查看内容
