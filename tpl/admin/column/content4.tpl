...
<option value="silver" style="background-color:silver;color:silver" {if $result.titlecolor=='silver'}selected="selected"{/if}>silver</option>
  ...
  <tr class="line">
    ...
    <td>
	  ...
	  <input type="hidden" class="input" name="photo" id="photo" value="{$result.photo}" size="70">该字段标志着链接是否属于图文链接	  </td>
  </tr>
  <tr class="line">
    <td>外部链接</td>
  ...
  <tr class="line">
    <td>链接描述</td>
    <td> <input class="input" name="intro" id="intro" value="{$result.intro}" size="70"></td>
  </tr>
 <!----------------------模型信息结束--------------------------------->
  <!--
  <tr class="line">
