...
{section name=s loop=$contentindexList}
  ...
  <td>{if $contentindexList[s].ifpub==1}已审核{else}<font color="#FF0000">未审核</font>{/if}</td>
...
<a href="/admin/column/content.php?action=pubview&id={$contentindexList[s].id}&cid={$cid}&mid={$mid}"><img src="/admin/images/pub.gif" align="absmiddle" alt="发布内容" /></td>
  </tr>
{/section}
</table>
</div>
