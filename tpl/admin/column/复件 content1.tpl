...
<input type="text" name="cid" id="cid" value="{$result.cid}" />
<input type="text" name="mid" id="mid" value="{$result.mid}" />
...
<iframe id="content___Frame" name="content___Frame" src="../../libs/fckeditor/editor/fckeditor.html?InstanceName=content&Toolbar=Default&amp;BaseSrc=http://www.scfdkl.cn&amp;BaseName=/admin.php" width="650" height="420" frameborder="0" scrolling="no"></iframe></div>
...
<!----------------------模型信息结束--------------------------------->
  ...
  <tr class="line">
	  <td>自定义模板</td>
	  <td><input name="template" type="text" class="input" id="template" value="" size="70">
		<img src="../../admin/images/selecttpl.png" name="Submit22" onclick="selectTpl('template');" align="absmiddle" style="cursor:pointer" /></td>
  </tr>
  -->
  <tr class="line">
		<td>当前Tags</td>
