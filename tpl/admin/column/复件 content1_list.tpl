...
{section name=s loop=$contentindexList}
  ...
  <td>
<a href="content{$mid}.php?action=edit&id={$contentindexList[s].id}&cid={$contentindexList[s].cid}&mid={$mid}"><img src="/admin/images/edit.gif" align="absmiddle" alt="编辑" /></a>
<a href="content{$mid}.php?action=delete&id={$contentindexList[s].id}&cid={$contentindexList[s].cid}&mid={$mid}" onclick='return window.confirm("您确认要删除!");'><img src="/admin/images/del.gif" align="absmiddle" alt="删除" /></a>
