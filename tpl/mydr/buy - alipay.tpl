        ...
        <div class="myinfo_content">
             <div class="pay_div">
                <form action="?action=getorder" id="getorder" method="post">
                    <h3>金币购买</h3>
                    <p>金币兑换比例:&nbsp;1&nbsp;元&nbsp;=&nbsp;10&nbsp;金币</p>
                    <p>金币：&nbsp;<input type="text" name="scores" class="input" id="scores" maxlength="5" >&nbsp;&nbsp;(&nbsp;所需要购买的金币，必须为正整数&nbsp;)</p>
                    <p>所需金额：<span class="pay_money" id="pay_money">{$oinfo.money|default:0}</span>&nbsp;元</p>
...
$(function(){
        ...
        $scores.bind('blur',function(){
                if(P_s.test($scores.val())&& $scores.val() >= 10)
                {
