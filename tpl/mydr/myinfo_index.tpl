...
<div class="c-content">
    <div class="myinfo">
        ...
        <div class="myinfo_content">
            ...
            {if $smarty.const.UTYPE=='2'}
                <table>
                    <tr>
                        <td>代理商名称：</td>
                        <td colspan="3"><input type="text" name="agperson" value="{$info.agperson}" /></td>
                    </tr>
                    <tr>
                        <td>代理商联系电话：</td>
                        <td colspan="3"><input type="text" name="agtelephone" value="{$info.agtelephone}" /></td>
                    </tr>
                </table>
            {else}
                <table>
