...
function load_year_map(fmobj,dktype,mapid){
    if(fmobj.daikuan_total1.value!="" && fmobj.all_total1.value!=""){
		if(fmobj.type.value!=3){
			...
			var month = fmobj.years.value*12;
			var imgHtml = "<img src=http://house.focus.cn/common/modules/housemarket/daikuan_year_map.php?lilv="+lilv+"&total="+daikuan_total+"&month="+month+"&type="+dktype+">";
		}else{
			var lilv_sy = getlilv(fmobj.lilv.value, 1, fmobj.years.value);
			var lilv_gjj = getlilv(fmobj.lilv.value, 2, fmobj.years.value);
			var dk_total_sy = fmobj.total_sy.value*10000;
			var dk_total_gjj = fmobj.total_gjj.value*10000;
			var month = fmobj.years.value*12;
			dktype += '_mix';
			var imgHtml = "<img src=http://house.focus.cn/common/modules/housemarket/daikuan_year_map.php?lilv_sy="+lilv_sy+"&lilv_gjj="+lilv_gjj+"&total_sy="+dk_total_sy+"&total_gjj="+dk_total_gjj+"&month="+month+"&type="+dktype+">";
		}
        document.getElementById(mapid).innerHTML = imgHtml;
    }else{
...
//提前还歀计算
function play(){
  if (document.tqhdjsq.dkzws.value==''||isNaN(document.tqhdjsq.dkzws.value)){
       alert('请填入贷款总额或者格式错误');
       document.tqhdjsq.dkzws.focus();
       return false;
  }else dkzys=parseFloat(document.tqhdjsq.dkzws.value)*10000;

  if(document.tqhdjsq.tqhkfs[1].checked && (document.tqhdjsq.tqhkws.value==''||isNaN(document.tqhdjsq.tqhkws.value))){
    alert('请填入部分提前还款额度或者格式错误');
    document.tqhdjsq.tqhkws.focus();
    return false;
   }
  s_yhkqs=parseInt(document.tqhdjsq.yhkqs.options[document.tqhdjsq.yhkqs.selectedIndex].value);
  ...
  //已还贷款期数
  yhdkqs=(parseInt(document.tqhdjsq.tqhksjn.options[document.tqhdjsq.tqhksjn.selectedIndex].value)-parseInt(document.tqhdjsq.yhksjn.options[document.tqhdjsq.yhksjn.selectedIndex].value))*12 + (parseInt(document.tqhdjsq.tqhksjy.options[document.tqhdjsq.tqhksjy.selectedIndex].value)-parseInt(document.tqhdjsq.yhksjy.options[document.tqhdjsq.yhksjy.selectedIndex].value));
...
function chk03()
{
if (document.myform.rg01.value==""||isNaN(document.myform.rg01.value)){
	alert("请填写现可用于购房的资金或格式错误");
	document.myform.rg01.focus();
}else
	if (document.myform.rg02.value==""||isNaN(document.myform.rg02.value)){
			alert("请填写现家庭月收入或格式错误");
			document.myform.rg02.focus();
	}else	
		if (document.myform.rg03.value==""||isNaN(document.myform.rg03.value)){
			alert("请填写预计家庭每月可用于购房支出或格式错误");
			document.myform.rg03.focus();
	}else	
		if (document.myform.rg06.value==""||isNaN(document.myform.rg06.value)){
			alert("请填写您计划购买房屋的面积或格式错误");
	...
	function doview(id)
		{
			if(id=='1')
			{
				document.getElementById('doview'+id).style.display='block';
				document.getElementById('doview2').style.display='none';
				document.getElementById('doview3').style.display='none';
				document.getElementById('doview4').style.display='none';
				document.getElementById('do'+id).className='cur';
				document.getElementById('do2').className='';
				document.getElementById('do3').className='';
				document.getElementById('do4').className='';
			}
			else if(id=='2')
			{
				document.getElementById('doview'+id).style.display='block';
				document.getElementById('doview1').style.display='none';
				document.getElementById('doview3').style.display='none';
				document.getElementById('doview4').style.display='none';
				document.getElementById('do'+id).className='cur';
				document.getElementById('do1').className='';
				document.getElementById('do3').className='';
				document.getElementById('do4').className='';
				}
				else if(id=='3')
